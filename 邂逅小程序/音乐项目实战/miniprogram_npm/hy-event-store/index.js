...
__DEFINE__(1738661489977, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1738661489978,"./event-store":1738661489979}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1738661489978, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1738661489979, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1738661489978,"./utils":1738661489980}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1738661489980, function(require, module, exports) {
...
return __REQUIRE__(1738661489977);
})()
