...
function FirstClassDecorator(targetClass) {
  ...
  var p = new targetClass("bik", 29);
  p.sleeping();
}
var Person = (function () {
  var _classDecorators = [FirstClassDecorator];
  ...
  var Person = (_classThis = /** @class */ (function () {
    ...
    Person_1.prototype.sleeping = function () {
      console.log(this.name + "正在睡觉");
    };
    Person_1.prototype.studying = function () {
